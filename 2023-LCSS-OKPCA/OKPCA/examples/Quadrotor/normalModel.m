function z_dot = normalModel(t,z)
    Kp = 5*[1,1,1,1,1]; % x,y,z,phi,theta % Kp = 5, Ki = 2; Kd = 8 for original data set
    Ki = 2*[1,1,1,1,1];
    Kd = 8*[1,1,1,1,1]; % minor anomaly: 8, 4, 2; major anomaly 1: 15,12,2;
    P.Kp = diag(Kp);
    P.Ki = diag(Ki);
    P.Kd = diag(Kd);
    P.xd = [0;0;0];
